...
FORMS   += moviemaker/MMControls.ui  moviemaker/MovieMaker.ui
HEADERS += moviemaker/MMControls.h   moviemaker/MovieMaker.h
SOURCES += moviemaker/MMControls.cpp moviemaker/MovieMaker.cpp
HEADERS += moviemaker/MovieRender.h   moviemaker/MMSettings.h
SOURCES += moviemaker/MovieRender.cpp moviemaker/MMSettings.cpp
